...
#include BLIK_LIBGIT2_U_git2__reset_h //original-code:"git2/reset.h"
#include BLIK_LIBGIT2_U_git2__checkout_h //original-code:"git2/checkout.h"
#include BLIK_LIBGIT2_U_git2__signature_h //original-code:"git2/signature.h"
#include BLIK_LIBGIT2_U_git2__config_h //original-code:"git2/config.h"
#include BLIK_LIBGIT2_U_git2__tree_h //original-code:"git2/tree.h"
...
#include BLIK_LIBGIT2_U_git2__sys__index_h //original-code:"git2/sys/index.h"
#include BLIK_LIBGIT2_U_git2__sys__hashsig_h //original-code:"git2/sys/hashsig.h"
...
static int interesting_merge(git_pqueue *list) //oz
{
	size_t i;
...
int git_merge__bases_many(git_commit_list **out, git_revwalk *walk, git_commit_list_node *one, git_vector *twos)
{
	...
	while (interesting_merge(&list)) { //oz
...
static int write_merge_msg_merge( //oz
	git_repository *repo,
	const git_annotated_commit *heads[],
	size_t heads_len)
{
	...
	size_t heads_len)
{
	...
	if ((error = git_repository__set_orig_head(repo, git_annotated_commit_id(our_head))) == 0 &&
		...
		error = write_merge_msg_merge(repo, heads, heads_len); //oz
	}
