...
#include BLIK_LIBGIT2_U_git2__diff_h //original-code:"git2/diff.h"
...
static void normalize_options_blame( //oz
		...
		git_blame_options *options)
{
	...
	normalize_options_blame(&normOptions, options, repo); //oz
