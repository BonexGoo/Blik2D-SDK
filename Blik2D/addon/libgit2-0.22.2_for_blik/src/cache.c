...
static void *cache_get_cache(git_cache *cache, const git_oid *oid, unsigned int flags) //oz
{
	khiter_t pos;
...
{
	return cache_get_cache(cache, oid, GIT_CACHE_STORE_RAW); //oz
}

git_object *git_cache_get_parsed(git_cache *cache, const git_oid *oid)
{
	return cache_get_cache(cache, oid, GIT_CACHE_STORE_PARSED); //oz
}

void *git_cache_get_any(git_cache *cache, const git_oid *oid)
{
	return cache_get_cache(cache, oid, GIT_CACHE_STORE_ANY); //oz
}
