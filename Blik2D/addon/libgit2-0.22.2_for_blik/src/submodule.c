...
#include BLIK_LIBGIT2_U_git2__sys__config_h //original-code:"git2/sys/config.h"
#include BLIK_LIBGIT2_U_git2__types_h //original-code:"git2/types.h"
#include BLIK_LIBGIT2_U_git2__index_h //original-code:"git2/index.h"
...
__KHASH_TYPE(str_submodule, const char *, void *) //oz
__KHASH_IMPL(
	str_submodule, static kh_inline, const char *, void *, 1, //oz
	...
	const char *alternate)
{
	...
	if (!git_strmap_valid_index(cache->submodules, pos)) {
		 ...
		 */
		pos = kh_put(str_submodule, (kh_str_submodule_t*) cache->submodules, sm->name, &error); //oz
