...
#include BLIK_LIBGIT2_V_git2__tag_h //original-code:<git2/tag.h>
#include BLIK_LIBGIT2_V_git2__object_h //original-code:<git2/object.h>
#include BLIK_LIBGIT2_V_git2__oid_h //original-code:<git2/oid.h>
#include BLIK_LIBGIT2_V_git2__branch_h //original-code:<git2/branch.h>
#include BLIK_LIBGIT2_V_git2__refs_h //original-code:<git2/refs.h>
#include BLIK_LIBGIT2_V_git2__refdb_h //original-code:<git2/refdb.h>
#include BLIK_LIBGIT2_V_git2__sys__refs_h //original-code:<git2/sys/refs.h>
#include BLIK_LIBGIT2_V_git2__signature_h //original-code:<git2/signature.h>
#include BLIK_LIBGIT2_V_git2__commit_h //original-code:<git2/commit.h>
...
static int peel_error_refs(int error, git_reference *ref, const char* msg) //oz
{
	giterr_set(
		GITERR_INVALID,
	...
	git_otype target_type)
{
	...
	if (ref->type == GIT_REF_OID) {
		...
		if ((error = git_reference_resolve(&resolved, ref)) < 0)
			return peel_error_refs(error, ref, "Cannot resolve reference"); //oz
	}
	...
	if (error < 0) {
		peel_error_refs(error, ref, "Cannot retrieve reference target"); //oz
		goto cleanup;
	}
