...
#include BLIK_LIBGIT2_V_git2__sys__refdb_backend_h //original-code:<git2/sys/refdb_backend.h>
#include BLIK_LIBGIT2_V_git2__sys__refs_h //original-code:<git2/sys/refs.h>
#include BLIK_LIBGIT2_V_git2__sys__reflog_h //original-code:<git2/sys/reflog.h>
