...
#include "revwalk.h"
#include "merge.h"
#include BLIK_LIBGIT2_U_git2__graph_h //original-code:"git2/graph.h"

static int interesting_graph(git_pqueue *list, git_commit_list *roots) //oz
{
	unsigned int i;
	...
	git_commit_list_node *two)
{
	...
	while (interesting_graph(&list, roots)) { //oz
