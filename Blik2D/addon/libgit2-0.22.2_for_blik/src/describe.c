 ...
 */
#include BLIK_LIBGIT2_U_git2__describe_h //original-code:"git2/describe.h"
#include BLIK_LIBGIT2_U_git2__strarray_h //original-code:"git2/strarray.h"
#include BLIK_LIBGIT2_U_git2__diff_h //original-code:"git2/diff.h"
#include BLIK_LIBGIT2_U_git2__status_h //original-code:"git2/status.h"
...
static int normalize_options_describe( //oz
	...
	git_describe_options *opts)
{
	...
	if ((error = normalize_options_describe(&normalized, opts)) < 0) //oz
		return error;
