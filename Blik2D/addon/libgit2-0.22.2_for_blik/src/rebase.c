...
#include BLIK_LIBGIT2_V_git2__types_h //original-code:<git2/types.h>
#include BLIK_LIBGIT2_V_git2__annotated_commit_h //original-code:<git2/annotated_commit.h>
#include BLIK_LIBGIT2_V_git2__rebase_h //original-code:<git2/rebase.h>
#include BLIK_LIBGIT2_V_git2__commit_h //original-code:<git2/commit.h>
#include BLIK_LIBGIT2_V_git2__reset_h //original-code:<git2/reset.h>
#include BLIK_LIBGIT2_V_git2__revwalk_h //original-code:<git2/revwalk.h>
#include BLIK_LIBGIT2_V_git2__notes_h //original-code:<git2/notes.h>
