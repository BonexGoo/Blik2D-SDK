...
#include BLIK_CURL_U_vauth__digest_h //original-code:"vauth/digest.h"
...
#include BLIK_CURL_U_non_M_ascii_h //original-code:"non-ascii.h" /* included for Curl_convert_... prototypes */
