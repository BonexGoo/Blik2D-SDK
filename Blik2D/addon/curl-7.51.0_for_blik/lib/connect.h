...
#include BLIK_CURL_U_nonblock_h //original-code:"nonblock.h" /* for curlx_nonblock(), formerly Curl_nonblock() */
#include BLIK_CURL_U_sockaddr_h //original-code:"sockaddr.h"
