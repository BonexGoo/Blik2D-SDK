...
#include BLIK_CURL_U_select_h //original-code:"select.h" /* for the socket readyness */
#include BLIK_CURL_U_inet_pton_h //original-code:"inet_pton.h" /* for IP addr SNI check */
...
#include BLIK_CURL_U_x509asn1_h //original-code:"x509asn1.h"
