...
#include BLIK_CURL_U_formdata_h //original-code:"formdata.h" /* for the boundary function */
#include BLIK_CURL_U_url_h //original-code:"url.h" /* for the ssl config check function */
...
#include BLIK_CURL_U_hostcheck_h //original-code:"hostcheck.h"
...
#include BLIK_OPENSSL_V_openssl__md5_h //original-code:<openssl/md5.h>
...
#include BLIK_OPENSSL_V_openssl__ocsp_h //original-code:<openssl/ocsp.h>
#endif

#include BLIK_CURL_U_warnless_h //original-code:"warnless.h"
#include BLIK_CURL_U_non_M_ascii_h //original-code:"non-ascii.h" /* for Curl_convert_from_utf8 prototype */
...
#include BLIK_OPENSSL_V_openssl__ui_h //original-code:<openssl/ui.h>
#endif
