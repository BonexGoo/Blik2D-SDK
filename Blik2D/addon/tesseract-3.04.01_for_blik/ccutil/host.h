...
#include BLIK_FAKEWIN_V_winbase_h //original-code:<winbase.h>             // winbase.h contains windows.h
#endif
...
typedef signed char inT8; // modified by BLIK, original code: typedef SIGNED char inT8;
