...
#include BLIK_TESSERACT_U_host_h //original-code:"host.h"  // For NULL.
...
template <class T> struct remove_reference_tesscallback_BLIK;
template<typename T> struct remove_reference_tesscallback_BLIK { typedef T type; };
template<typename T> struct remove_reference_tesscallback_BLIK<T&> { typedef T type; };
...
class _ConstTessMemberResultCallback_1_0 : public TessResultCallback<R> {
 ...
 private:
  const T* object_;
  MemberSignature member_;
  typename remove_reference_tesscallback_BLIK<P1>::type p1_;
...
class _ConstTessMemberResultCallback_2_0 : public TessResultCallback<R> {
 ...
 private:
  ...
  MemberSignature member_;
  typename remove_reference_tesscallback_BLIK<P1>::type p1_;
  typename remove_reference_tesscallback_BLIK<P2>::type p2_;
...
class _ConstTessMemberResultCallback_3_0 : public TessResultCallback<R> {
 ...
 private:
  ...
  typename remove_reference_tesscallback_BLIK<P1>::type p1_;
  typename remove_reference_tesscallback_BLIK<P2>::type p2_;
  typename remove_reference_tesscallback_BLIK<P3>::type p3_;
...
class _ConstTessMemberResultCallback_4_0 : public TessResultCallback<R> {
 ...
 private:
  ...
  typename remove_reference_tesscallback_BLIK<P2>::type p2_;
  typename remove_reference_tesscallback_BLIK<P3>::type p3_;
  typename remove_reference_tesscallback_BLIK<P4>::type p4_;
...
class _ConstTessMemberResultCallback_5_0 : public TessResultCallback<R> {
 ...
 private:
  ...
  typename remove_reference_tesscallback_BLIK<P3>::type p3_;
  typename remove_reference_tesscallback_BLIK<P4>::type p4_;
  typename remove_reference_tesscallback_BLIK<P5>::type p5_;
...
class _ConstTessMemberResultCallback_6_0 : public TessResultCallback<R> {
 ...
 private:
  ...
  typename remove_reference_tesscallback_BLIK<P4>::type p4_;
  typename remove_reference_tesscallback_BLIK<P5>::type p5_;
  typename remove_reference_tesscallback_BLIK<P6>::type p6_;
