...
#if defined(_WIN32)
#ifdef _MSC_VER
#include BLIK_TESSERACT_U_vcsversion_h //original-code:"vcsversion.h"
#include BLIK_TESSERACT_U_mathfix_h //original-code:"mathfix.h"
#elif MINGW
...
#include <fcntl.h>
#include BLIK_FAKEWIN_V_io_h //original-code:<io.h>
#else
#include <dirent.h>
#include <libgen.h>
#include <string.h>
...
#include BLIK_OPENALPR_U_allheaders_h //original-code:"allheaders.h"

#include BLIK_TESSERACT_U_baseapi_h //original-code:"baseapi.h"
#include BLIK_TESSERACT_U_blobclass_h //original-code:"blobclass.h"
#include BLIK_TESSERACT_U_resultiterator_h //original-code:"resultiterator.h"
#include BLIK_TESSERACT_U_mutableiterator_h //original-code:"mutableiterator.h"
#include BLIK_TESSERACT_U_thresholder_h //original-code:"thresholder.h"
#include BLIK_TESSERACT_U_tesseractclass_h //original-code:"tesseractclass.h"
#include BLIK_TESSERACT_U_pageres_h //original-code:"pageres.h"
#include BLIK_TESSERACT_U_paragraphs_h //original-code:"paragraphs.h"
#include BLIK_TESSERACT_U_tessvars_h //original-code:"tessvars.h"
#include BLIK_TESSERACT_U_control_h //original-code:"control.h"
#include BLIK_TESSERACT_U_dict_h //original-code:"dict.h"
#include BLIK_TESSERACT_U_pgedit_h //original-code:"pgedit.h"
#include BLIK_TESSERACT_U_paramsd_h //original-code:"paramsd.h"
#include BLIK_TESSERACT_U_output_h //original-code:"output.h"
#include BLIK_TESSERACT_U_globaloc_h //original-code:"globaloc.h"
#include BLIK_TESSERACT_U_globals_h //original-code:"globals.h"
#include BLIK_TESSERACT_U_edgblob_h //original-code:"edgblob.h"
#include BLIK_TESSERACT_U_equationdetect_h //original-code:"equationdetect.h"
#include BLIK_TESSERACT_U_tessbox_h //original-code:"tessbox.h"
#include BLIK_TESSERACT_U_makerow_h //original-code:"makerow.h"
#include BLIK_TESSERACT_U_otsuthr_h //original-code:"otsuthr.h"
#include BLIK_TESSERACT_U_osdetect_h //original-code:"osdetect.h"
#include BLIK_TESSERACT_U_params_h //original-code:"params.h"
#include "renderer.h"
#include BLIK_TESSERACT_U_strngs_h //original-code:"strngs.h"
#include BLIK_TESSERACT_U_openclwrapper_h //original-code:"openclwrapper.h"
...
static void AddIdTohOCR(STRING* hocr_str, const std::string base, int num1, int num2) {
  ...
  char id_buffer[2048]; // modified by BLIK (char id_buffer[bufsize])
  if (num2 >= 0) {
