...
#include BLIK_TESSERACT_U_blobbox_h //original-code:"blobbox.h"       // For BlobRegionType.
#include BLIK_TESSERACT_U_ndminx_h //original-code:"ndminx.h"
#include BLIK_TESSERACT_U_ocrblock_h //original-code:"ocrblock.h"
#include BLIK_TESSERACT_U_rect_h //original-code:"rect.h"           // For TBOX.
#include BLIK_TESSERACT_U_scrollview_h //original-code:"scrollview.h"
#include "tabfind.h"        // For WidthCallback.
#include BLIK_TESSERACT_U_tabvector_h //original-code:"tabvector.h"      // For BLOBNBOX_CLIST.
