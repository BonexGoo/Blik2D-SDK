...
#include BLIK_TESSERACT_U_colpartition_h //original-code:"colpartition.h"   // For ColPartition_LIST.
#include BLIK_TESSERACT_U_genericvector_h //original-code:"genericvector.h"  // For GenericVector.
