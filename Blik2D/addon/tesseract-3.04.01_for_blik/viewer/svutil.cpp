...
#include <stdio.h>
#ifdef _WIN32
// removed by BLIK: struct addrinfo {
// removed by BLIK:   struct sockaddr* ai_addr;
// removed by BLIK:   int ai_addrlen;
// removed by BLIK:   int ai_family;
// removed by BLIK:   int ai_socktype;
// removed by BLIK:   int ai_protocol;
// removed by BLIK: };
#else
#include <arpa/inet.h>
