...
namespace Catch{
    ...
    extern "C" BLIK_FAKEWIN_DECLSPEC_DLLIMPORT void BLIK_FAKEWIN_STDCALL DebugBreak();
...
#elif defined(_MSC_VER)
    extern "C" BLIK_FAKEWIN_DECLSPEC_DLLIMPORT int BLIK_FAKEWIN_STDCALL IsDebuggerPresent();
    namespace Catch {
        bool isDebuggerActive() {
...
#ifdef CATCH_PLATFORM_WINDOWS
    extern "C" BLIK_FAKEWIN_DECLSPEC_DLLIMPORT void BLIK_FAKEWIN_STDCALL OutputDebugStringA( const char* );
    namespace Catch {
        void writeToDebugConsole( std::string const& text ) {
