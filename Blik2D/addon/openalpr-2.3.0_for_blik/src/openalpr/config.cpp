...
namespace alpr
{
  ...
  void Config::loadCommonValues(string configFile)
  {
    ...
    maxDetectionInputWidth = getInt(ini, defaultIni, "", "max_detection_input_width", 640);
    maxDetectionInputHeight = getInt(ini, defaultIni, "", "max_detection_input_height", 480);
