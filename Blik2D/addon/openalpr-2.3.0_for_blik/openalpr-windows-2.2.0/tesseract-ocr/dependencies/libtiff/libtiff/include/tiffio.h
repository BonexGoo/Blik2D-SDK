 ...
 */
#include BLIK_OPENALPR_U_tiff_h //original-code:"tiff.h"
#include BLIK_OPENALPR_U_tiffvers_h //original-code:"tiffvers.h"
...
typedef struct {
	const char* name; // modified by BLIK, original-code: (char* name;)
	uint16		scheme;
	TIFFInitMethod	init;
} TIFFCodec;
...
typedef	struct {
	...
	const char	*field_name;		/* ASCII name */ // modified by BLIK, original-code: (char	*field_name;)
} TIFFFieldInfo;
