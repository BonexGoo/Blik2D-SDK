...
#include BLIK_FAKEWIN_V_io_h //original-code:<io.h>		/* for open, close, etc. function prototypes */
#include <stdio.h>
#endif
...
#ifdef __GNUC__
// removed by BLIK: extern	char* malloc();
// removed by BLIK: extern	char* realloc();
#else
#include BLIK_FAKEWIN_V_malloc_h //original-code:<malloc.h>
#endif
