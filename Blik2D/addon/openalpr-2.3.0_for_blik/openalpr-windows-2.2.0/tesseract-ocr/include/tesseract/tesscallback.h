...
// remove for BLIK:template <class T> struct remove_reference;
// remove for BLIK:template<typename T> struct remove_reference { typedef T type; };
// remove for BLIK:template<typename T> struct remove_reference<T&> { typedef T type; };
