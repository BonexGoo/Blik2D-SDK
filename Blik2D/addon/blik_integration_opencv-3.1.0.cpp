...
#include "blik_integration_opencv-3.1.0.h"
...
#define APIENTRY
#define GUID_DEFINED
#include <addon/opencv-3.1.0_for_blik/modules/core/include/opencv2/core/base.hpp>
#define CV_Assert(expr) BLIK_ASSERT_ARG("OpenCV 내부의 에러입니다", expr, __FILE__, __LINE__, __FUNCTION__)

#include <addon/opencv-3.1.0_for_blik/modules/core/src/algorithm.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/alloc.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/arithm.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/array.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/command_line_parser.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/conjugate_gradient.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/convert.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/copy.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/cuda_gpu_mat.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/cuda_host_mem.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/cuda_info.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/cuda_stream.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/datastructs.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/directx.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/downhill_simplex.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/dxt.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/gl_core_3_1.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/glob.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/kmeans.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/lapack.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/lda.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/lpsolver.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/mathfuncs.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/mathfuncs_core.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/matmul.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/matop.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/matrix.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/matrix_decomp.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/merge.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/ocl.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/opengl.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/out.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/parallel.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/parallel_pthreads.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/pca.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/rand.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/split.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/stat.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/stl.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/system.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/tables.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/types.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/umatrix.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/va_intel.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/core/src/persistence.cpp>

#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/accum.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/approx.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/blend.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/canny.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/clahe.cpp>
#define BLOCK_SIZE BLOCK_SIZE_color_BLIK
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/color.cpp>
#undef BLOCK_SIZE
#define argsort argsort_color_BLIK
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/colormap.cpp>
#undef argsort
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/connectedcomponents.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/contours.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/convhull.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/corner.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/cornersubpix.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/demosaicing.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/deriv.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/distransform.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/drawing.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/emd.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/featureselect.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/filter.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/floodfill.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/gabor.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/generalized_hough.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/geometry.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/grabcut.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/hershey_fonts.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/histogram.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/hough.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/intersection.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/linefit.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/lsd.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/matchcontours.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/min_enclosing_triangle.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/moments.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/morph.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/phasecorr.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/pyramids.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/rotcalipers.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/samplers.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/segmentation.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/shapedescr.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/smooth.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/spatialgradient.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/subdivision2d.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/sumpixels.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/tables.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/templmatch.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/thresh.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/undistort.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgproc/src/utils.cpp>

#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/bitstrm.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_base.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_bmp.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_exr.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_gdal.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_hdr.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_jpeg.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_jpeg2000.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_png.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_pxm.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_sunras.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_tiff.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/grfmt_webp.cpp>
// 현재 본 옵션 사용안함 - #include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/jpeg_exif.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/loadsave.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/rgbe.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/imgcodecs/src/utils.cpp>

#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/highgui/src/window.cpp>
#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/objdetect/src/cascadedetect.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/objdetect/src/haar.cpp>
#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/feature2d.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/agast_score.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/agast.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/fast_score.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/fast.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/keypoint.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/matchers.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/brisk.cpp>
#include <addon/opencv-3.1.0_for_blik/modules/features2d/src/draw.cpp>
#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/flann/src/miniflann.cpp>
#undef __OPENCV_PRECOMP_H__
#include <addon/opencv-3.1.0_for_blik/modules/video/src/bgfg_gaussmix2.cpp>

// ■ 대체구현(addon/opencv-3.1.0_for_blik/modules/imgproc/src/imgwarp.cpp)
