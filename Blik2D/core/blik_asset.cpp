...
public:
    ...
    {
        #ifndef BLIK_RULE_ADMIT_MIDDLE_PATH
            return filename;
        #else
...
namespace BLIK
{
    ...
    {
        AssetPathClass* NewAssetPath = (AssetPathClass*) Buffer::Alloc<AssetPathClass>(BLIK_DBG 1);
    ...
    {
        BLIK_ASSERT("assetpath인수가 nullptr입니다", assetpath);
        BLIK_ASSERT("pathname인수가 nullptr입니다", pathname);
